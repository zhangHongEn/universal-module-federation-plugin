 ...
 */
module.exports.parseVersion = str => {
...
/* eslint-disable eqeqeq */
module.exports.rangeToString = range => {
 ...
 */
module.exports.satisfy = (range, version) => {
	if (0 in range) {
		// @ts-expect-error
...
module.exports.rangesMaxSatisfying = function(versions = [], range = "*") {
	const descVersions = [...versions].sort((p, n) => versionLt(p, n) ? 1 : -1)
